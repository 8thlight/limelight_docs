slide do
  ...
  if next_walkthrough
    ...
    tutorial_link :id => "next_slideshow", :slideshow => next_walkthrough.slideshow, :title => next_walkthrough.title, :text => " #{next_walkthrough.title}", :styles => "directions_tutorial_link"
  else
