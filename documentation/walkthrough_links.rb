...
toc_link :id => "text_walkthrough",             :text => "Text",            :slideshow => "text", :title => "Text"
...
toc_link :id => "prop_layout_walkthrough",       :text => "Prop Layout",     :slideshow => "prop_layout", :title => "Prop Layout"
toc_link :id => "float_walkthrough",             :text => "Floating Props",  :slideshow => "float", :title => "Floating Props"
toc_link :id => "prop_sizing_walkthrough",       :text => "Prop Sizing",     :slideshow => "prop_sizing", :title => "Prop Sizing"
...
toc_link :id => "sound_walkthrough",            :text => "Sound",           :slideshow => "sound", :title => "Sound"
