...
def update_previous_button
  if at_beginning?
    ...
    @previous_button.hover_style.clear_extensions
  else
    @previous_button.style.transparency = "0%"
    @previous_button.hover_style.add_extension(scene.styles["previous_button.hover"])
  end
end
...
def update_next_button
  if at_end?
    ...
    @next_button.hover_style.clear_extensions
  else
    @next_button.style.transparency = "0%"
    @next_button.hover_style.add_extension(scene.styles["next_button.hover"])
  end
end
