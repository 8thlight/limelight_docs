...
COMMENT
  ...
  it "should place == in a header style" do
    comments = <<COMMENT
# == props.rb This is an example
COMMENT
    
    LimelightRDoc::CommentFormatter.format("method", comments).should == ["rdoc_heading :text => 'props.rb'",
                                                                         "method_description :text => 'This is an example'"]

  end

  it "should close the previous comment" do
    comments = <<COMMENT
# I am a comment
# == props.rb This is also an example
COMMENT
    
    LimelightRDoc::CommentFormatter.format("method", comments).should == ["method_description :text => 'I am a comment'",
                                                                          "rdoc_heading :text => 'props.rb'",
                                                                          "method_description :text => 'This is also an example'"]
  end

  it "should create a new multi line comment" do
    comments = <<COMMENT
# == props.rb This is an example
...
COMMENT
    ...
    LimelightRDoc::CommentFormatter.format("method", comments).should == ["rdoc_heading :text => 'props.rb'",
                                                                          "method_description :text => 'This is an example That continues on another line'"]
  end
