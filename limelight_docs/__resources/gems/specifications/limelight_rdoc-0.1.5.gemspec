...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "Rakefile", "VERSION", "bin/ll_rdoc", "lib/limelight_rdoc.rb", "lib/limelight_rdoc/attribute_generator.rb", "lib/limelight_rdoc/class_file_generator.rb", "lib/limelight_rdoc/comment_formatter.rb", "lib/limelight_rdoc/constant_generator.rb", "lib/limelight_rdoc/limelight_generator.rb", "lib/limelight_rdoc/limelight_rdoc.rb", "lib/limelight_rdoc/method_generator.rb", "lib/limelight_rdoc/method_source_generator.rb", "lib/limelight_rdoc/prop_string.rb", "spec/attribute_generator_spec.rb", "spec/class_file_generator_spec.rb", "spec/comment_formatter_spec.rb", "spec/constant_generator_spec.rb", "spec/limelight_generator_spec.rb", "spec/limelight_rdoc_spec.rb", "spec/method_generator_spec.rb", "spec/method_source_generator_spec.rb", "spec/spec_helper.rb"]
  s.homepage = %q{http://github.com/paytonrules/limelight_rdoc}
  s.rdoc_options = ["--charset=UTF-8"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.3.3}
  s.summary = %q{Generates rdoc in limelight format}
  s.test_files = ["spec/attribute_generator_spec.rb", "spec/class_file_generator_spec.rb", "spec/comment_formatter_spec.rb", "spec/constant_generator_spec.rb", "spec/limelight_generator_spec.rb", "spec/limelight_rdoc_spec.rb", "spec/method_generator_spec.rb", "spec/method_source_generator_spec.rb", "spec/spec_helper.rb"]
